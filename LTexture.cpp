...
{
    //std::cout<<"here in ltexture"<<std::endl;//Get rid of preexisting texture
    Free();
    ...
    {
        //std::cout<<"here in ltexture"<<std::endl;
        //Color key image
        ...
        {
            //std::cout<<"here in ltexture"<<std::endl;//Get image dimensions
